...
@section('body')
    <div class="bg-primary-color-500">
        <div class="container mx-auto my-0 py-16">
            ...
            <h1 class="mb-0 text-primary-color-700">Sobre</h1>
    ...
    <div id="indicators-carousel" class="container relative mx-auto my-16" data-carousel="static">
        <div class="inline-flex rounded-md shadow-sm" role="group">
            <button type="button" class="inline-flex items-center py-2 px-4 text-sm font-medium bg-gray-700 border-gray-600 text-white hover:text-white hover:bg-gray-600 focus:ring-blue-500 focus:text-white rounded-tl-md" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0">
                Missão
            </button>
            ...
            <button type="button" class="inline-flex items-center py-2 px-4 text-sm font-medium bg-gray-700 border-gray-600 text-white hover:text-white hover:bg-gray-600 focus:ring-blue-500 focus:text-white rounded-tr-md" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2">
                Valores
            </button>
        </div>
