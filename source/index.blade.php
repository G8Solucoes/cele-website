...
@section('body')
    <div class="w-full bg-secondary-color-500">
        <div class="container mx-auto grid lg:grid-cols-2 grid-cols-1 h-96 overflow-hidden">
            <div class="flex flex-col  w-9/12 justify-center text-white">
                ...
                <a href="#" class="p-4 rounded-lg bg-secondary-color-600" style="width: 300px; height: 150px;">
                    <img src="/assets/images/lider_icon.svg" style="z-index: 1; width: 200px; height: 120px; position: absolute; left: 40px;" alt="" srcset="">
    ...
    <div class="w-full bg-primary-color-500">
        <div class="container mx-auto grid lg:grid-cols-2 grid-cols-1 h-96 overflow-hidden bg-primary-color-500">
            ...
            <div class="bg-cover-image-02 bg-cover bg-right bg-no-repeat hidden lg:block"></div>
        </div>
    </div>
